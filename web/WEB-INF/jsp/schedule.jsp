...
<html>
    ...
    <head>
        ...
        <style>
            ...
            .hero2 {
                ...
                text-align: center;
                /* Background styles */
               background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 0.5)),url('recursos/img/schedule/LogoMschedules.svg');
            ...
            .arrow_box {
                position: relative;
                background: transparent url('recursos/img/schedule/bgScheduleDemo.svg') 4px 0px no-repeat;
                padding: 25px;
                padding-left: 15px;
                padding-right: 15px;
    ...
    <main>
        ...
        <img src="recursos/img/schedule/LineaSeparacion.svg" class="lineaSeparacion">
